        ...
        <SafeAreaView className="flex-1 bg-background">
            <View className="home-navbar px-5">
                ...
                <View className="tab-header">
                    <Text className="text-2xl font-sans-bold"> Log in </Text>
                </View>
            </View>
            ...
            <View className="flex-1 items-center px-5">
                ...
                <View className="home-card w-full mt-5 px-5 py-5 border border-solid border-muted-foreground rounded-2xl">
                    <View className="flex-col justify-between mb-4 gap-2">
                        ...
                        <Text className="text-foreground/70 text-lg">Ready for another session?</Text>
                    </View>
                    ...
                    <View className="flex-col gap-1">
                        ...
                        {error ? (
                            <View className="mt-4 rounded-lg border border-red-400 bg-muted px-3 py-2">
                                <Text className="text-sm font-sans-medium text-red-600">{error}</Text>
                            </View>
                        ) : null}

                        <Pressable className="bg-accent rounded-lg px-3 py-3 mt-7 items-center" onPress={handleSignIn} disabled={loading}>
                            <Text className="text-2xl font-sans-bold text-white">{loading ? "Logging in..." : "Log In"}</Text>
                        </Pressable>
